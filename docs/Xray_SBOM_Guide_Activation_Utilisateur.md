...
## Bonne nouvelle : le SBOM sera bientôt activé

La fonctionnalité **SBOM** de Xray va être activée prochainement dans notre environnement. Ce guide vous explique, sans jargon, ce que cela veut dire et comment l'utiliser au quotidien.

> **Vous n'avez rien à activer vous-même.** La mise en service est réalisée par l'équipe d'administration. Vous serez prévenu dès que ce sera disponible. Ce guide est là pour que vous soyez prêt le jour J.
...
Prochainement — vous recevrez une communication dédiée.
